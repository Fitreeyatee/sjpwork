...
if ("POST".equalsIgnoreCase(request.getMethod())) {
	...
	try {
      ...
      out.write("\t}\n");
      out.write("\t.b1{\n");
      out.write("\t\tbackground-color: #FF1493;\n");
      ...
      out.write("\t\t<img class=\"m1\" src=\"assets/img/user.png\"><br>\n");
      out.write("        <div class=\"text-center mb-4\">\n");
      out.write("            <i class=\"fas fa-user fa-4x mb-3\" ></i>\n");
      out.write("           <h2 class=\"co\">กรุณา Login เข้าสู่ระบบ</h2>\n");
      out.write("        </div>\n");
      out.write("\t\t");
 ...
 if (request.getParameter("registered") != null) { out.print("autofocus"); } 
      ...
      out.write("\t\t</div>\n");
      out.write("\t\t\t\t<button round  class=\"b1\" type=\"submit\">ลงชื่อเข้าใช้</button>\n");
      out.write("\t\t\t\t<button class=\"b2\" ><a href=\"register.jsp\"> สมัครผู้ใช้ใหม่</a></button>\n");
      out.write("\t\t\n");
      out.write("\t\n");
      out.write("\t\t\n");
      out.write("        \n");
