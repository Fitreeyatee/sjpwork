...
try {
	if (statement != null){
      ...
      out.write("\t}\n");
      out.write("\t.card-body{\n");
      out.write("\t\tbackground-color: #EE82EE;\n");
      out.write("\t}\n");
      out.write("\t\t\t\n");
      out.write("</style>\n");
      out.write("\t\t\t\n");
      ...
      out.write("\t\t<h2 class=\"co\"><i class=\"fas fa-id-card\"></i>&nbsp; ผู้จัดทำ</h2>\n");
      out.write("\t\t<div class=\"card\">\n");
      out.write("\t\t\t<div class=\"card-body\">\n");
      out.write("\t\t\t\t<div class=\"row text-center pt-4\">\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-4 pb-4\">\n");
      out.write("\t\t\t\t\t\t<img alt=\"ฟิตรียาตี สมาแอ\"  width=\"140\" height=\"140\" src=\"assets/img/fit.jpg\" />\n");
      out.write("\t\t\t\t\t\t<br><br>\n");
      out.write("\t\t\t\t\t\t<h3>นางสาว ฟิตรียาตี สมาแอ</h3>\n");
      out.write("\t\t\t\t\t\t<p class=\"text-muted\">รหัสประจำตัวนักศึกษา: 6139010044</p>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-4 pb-4\">\n");
      out.write("\t\t\t\t\t\t<img alt=\"ฟัยซอล ดาตู\"  width=\"140\" height=\"140\" src=\"assets/img/san.jpg\" />\n");
      out.write("\t\t\t\t\t\t<br><br>\n");
      out.write("\t\t\t\t\t\t<h3>นางสาว นูรีซา เจ๊ะโกะ </h3>\n");
      out.write("\t\t\t\t\t\t<p class=\"text-muted\">รหัสประจำตัวนักศึกษา: 6139010030</p>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"col-lg-4 pb-4\">\n");
      out.write("\t\t\t\t\t\t<img alt=\"ธีระ บินกาเซ็ม\"  width=\"140\" height=\"140\" src=\"assets/img/teera.jpg\" />\n");
      out.write("\t\t\t\t\t<br><br>\n");
      out.write("\t\t\t\t\t\t<h3>ธีระ บินกาเซ็ม</h3>\n");
