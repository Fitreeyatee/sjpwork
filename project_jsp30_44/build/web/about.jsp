			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						<img alt="ฟิตรียาตี สมาแอ"  width="140" height="140" src="assets/img/fit.jpg" />
						<br><br>
						<h3>นางสาว ฟิตรียาตี สมาแอ</h3>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010044</p>
					</div>
					<div class="col-lg-4 pb-4">
						<img alt="ฟัยซอล ดาตู"  width="140" height="140" src="assets/img/san.jpg" />
						<br><br>
						<h3>นางสาว นูรีซา เจ๊ะโกะ </h3>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010030</p>
