...
<body class="b3">
    <form action="register.jsp" method="POST" class="form-signup">
		<img class="m1" src="assets/img/add.png" >
        <div class="text-center mb-4">
            <i class="fas fa-user-plus fa-4x mb-4"></i>
            <h1 class="h3 mb-2 font-weight-normal"   id="j1">สมัครผู้ใช้ใหม่</h1>
        </div>
		<%
		...
		<button  class="b1" type="submit">สมัครผู้ใช้ใหม่</button>
		<button class="b2" ><a href="login.jsp"> ลงชื่อเข้าใช้</a></button>
